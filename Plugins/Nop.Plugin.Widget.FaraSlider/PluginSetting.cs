...
namespace Nop.Plugin.Widget.FaraSlider
{
    public class PluginSetting : BasePlugin , IWidgetPlugin/*, IAdminMenuPlugin*/
    {
        ...
        {
            return $"{_webHelper.GetStoreLocation()}Admin/FaraSlider/Configure";
        }
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            //controllerName = "FaraSlider";
            //routeValues = new RouteValueDictionary { { "Namespaces", "Nop.Plugin.Widget.FaraSlider.Controllers" }, { "area", null } };
        }
        ...
        public void GetDisplayWidgetRoute(string widgetZone, out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            {
                {"Namespaces", "Nop.Plugin.Widget.FaraSlider.Controllers"},
                {"area", null},
